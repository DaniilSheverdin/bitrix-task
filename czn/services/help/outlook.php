...
<?=GetMessage("SERVICES_INFO1", array("#SITE#" => "/czn/"))?>
<?
if (CModule::IncludeModule("intranet") && CModule::IncludeModule("iblock"))
{
?>
<table style="margin-top:7px;">
	<tr><td><li><a href="javascript:<?echo htmlspecialcharsbx(CIntranetUtils::GetStsSyncURL(array('LINK_URL' => '/czn/company/'), 'contacts'))?>"><?=GetMessage("SERVICES_LINK1")?></a></td></tr>
...
<?=GetMessage("SERVICES_INFO2", array("#SITE#" => "/czn/"))?>
