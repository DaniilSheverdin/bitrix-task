...
if(CModule::IncludeModule('voximplant'))
{
	$aMenuLinks = Array(
		Array(
			...
			"/czn/services/telephony/lines.php",
		...
		Array(
			...
			"/czn/services/telephony/index.php",
		...
		Array(
			...
			"/czn/services/telephony/users.php",
			Array(),
		...
		Array(
			...
			"/czn/services/telephony/groups.php",
		...
		Array(
			...
			"/czn/services/telephony/phones.php",
			Array(),
		...
		Array(
			...
			"/czn/services/telephony/permissions.php",
		...
		Array(
			...
			"/czn/services/telephony/ivr.php",
		...
		Array(
			...
			"/czn/services/telephony/configs.php",
			Array(),
