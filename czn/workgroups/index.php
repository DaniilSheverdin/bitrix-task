...
?><?$APPLICATION->IncludeComponent("bitrix:socialnetwork_group", ".default", Array(
	...
	"PATH_TO_SUBSCRIBE" => "/czn/company/personal/subscribe/",
	"PATH_TO_GROUP_CREATE"	=>	"/czn/company/personal/user/#user_id#/groups/create/",
	"PATH_TO_SEARCH_EXTERNAL"	=>	"/czn/company/index.php",
	"PATH_TO_CONPANY_DEPARTMENT" => "/czn/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_MESSAGES_CHAT" => "/czn/company/personal/messages/chat/#user_id#/",
	"PATH_TO_USER_CALENDAR" => "/czn/company/personal/user/#user_id#/calendar/",
	"PATH_TO_MESSAGE_FORM_MESS" => "/czn/company/personal/messages/form/#user_id#/#message_id#/",
	"PATH_TO_USER_LOG" => "/czn/company/personal/log/",
	"PATH_TO_VIDEO_CALL" => "/czn/company/personal/video/#user_id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/czn/company/personal/user/#user_id#/bizproc/",
	"PATH_TO_BIZPROC_TASK" => "/czn/company/personal/user/#user_id#/bizproc/#id#/",
	"SEF_MODE"	=>	"Y",
	"SEF_FOLDER"	=>	"/czn/workgroups/",
	"AJAX_MODE"	=>	"N",
	...
	"CALENDAR_PATH_TO_RES_MEETING" => "/czn/services/?page=meeting&meeting_id=#id#",
	...
	"CALENDAR_PATH_TO_VIDEO_MEETING_DETAIL" => "/czn/services/video/detail.php?ID=#ID#",
	"CALENDAR_PATH_TO_VIDEO_MEETING" => "/czn/services/video/",
