  ...
  <div class="col-12">
    <div class="kpi_rules">
      <div class="row ml-5">
        <div class="col-auto">
          <div class="link mt-4">
            <a href="<?=SITE_DIR?>kpi/computed_rules_extra">
        ...
        <div class="col-auto">
          <div class="link mt-4">
            ...
            <a href="<?=SITE_DIR?>kpi/set_salary?department=<?=$_REQUEST['department']?>">
      ...
      <div class="data-table">
        ...
        <? foreach ($arResult['DEPARTMENT_DATA'] as $key => $value): ?>
          <div class="row data-table_row">
            <div class="col-3">
              <div class="link"><a href="<?=SITE_DIR?>kpi/computed_rules_change?department=<?=$_REQUEST['department']?>&work_position=<?=$key?>"><?=$value['NAME']?></a></div>
            </div>
