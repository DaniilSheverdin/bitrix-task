...
<? if ($arResult['ACCESS_DEPARTMENT']): ?>
  <div class="mt-5 period"><?=$arResult['PERIOD']?></div>
<div class="row">
  <div class="col-12">
    <div class="kpi_rules">
      <div class="row ml-5">
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="collapse show" id="collapseExample<?=$id?>">
              ...
              <? if ($arResult['DEPARTMENT_DATA']['WP_LAST_CHANGES'][$id]): ?>
              <div class="mb-4">
                <b><?=Loc::getMessage('TITLE_LAST_CHANGES')?>:</b> <?=$arResult['DEPARTMENT_DATA']['WP_LAST_CHANGES'][$id]?>
              </div>
              <? endif; ?>
