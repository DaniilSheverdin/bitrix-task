...
<div class="row">
    <div class="col-9 offset-1">
        <form action="" class="form_vaccination">
            ...
            <div class="mb-5" id="type_vaccination_block">
                <div class="input_group">
                    <label for="fio">Выберите тип вакцинации</label>
                    <div class="ui-ctl ui-ctl-after-icon ui-ctl-dropdown">
                        <div class="ui-ctl-after ui-ctl-icon-angle"></div>
                        <select name="type_vaccination" class="ui-ctl-element">
                            <? foreach ($arResult['TYPES_VACCINATION'] as $arType): ?>
                                <option js-xml-id="<?= $arType['XML_ID'] ?>" value="<?= $arType['ID'] ?>"><?= $arType['VALUE'] ?></option>
                            <? endforeach; ?>
                        </select>
                    </div>
                </div>
                <a href="#" id="next_step" class="ui-btn vaccination_send ui-btn-success">Далее</a>
            </div>

            <div class="hidden_form">
                <h3 class="type_vaccination_title"></h3>
                <div class="input_group">
                    <label for="fio">ФИО</label>
                    <div class="ui-ctl ui-ctl-textbox">
                        <input value="<?= $data['NAME'] ?? $USER->GetLastName() . ' ' . $USER->GetFirstName() . ' ' . $USER->GetSecondName() ?>" name="fio" id="fio"
                               type="text" class="ui-ctl-element required">
                    </div>
                </div>
                ...
                <div class="input_group">
                    ...
                    <div class="ui-ctl ui-ctl-after-icon ui-ctl-date">
                        ...
                        <div class="ui-ctl-element"><input id="birthday_date" class="required-change" type="text" value="" name="birthday_date"
                                                           onclick="BX.calendar({node: this, field: this, bTime: false}); changeCalendar(this)"></div>
                    </div>
                </div>
                ...
                <div class="input_group">
                    ...
                    <div class="ui-ctl ui-ctl-after-icon ui-ctl-date">
                        <div class="ui-ctl-after ui-ctl-icon-calendar"></div>
                        <div class="ui-ctl-element"><input id="passport_issued_date" class="required-change" type="text" value="" name="passport_issued_date"
                                                           onclick="BX.calendar({node: this, field: this, bTime: false}); changeCalendar(this)"></div>
                    </div>
                </div>
                ...
                <div class="input_group">
                    ...
                    <div class="ui-ctl ui-ctl-after-icon ui-ctl-date ">
                        <div class="ui-ctl-after ui-ctl-icon-calendar"></div>
                        <div class="ui-ctl-element "><input id="vac_date" class="required-change" type="text" value="" name="vac_date"
                                                            onclick="BX.calendar({node: this, field: this, bTime: false}); changeCalendar(this)"></div>
                    </div>
                </div>
