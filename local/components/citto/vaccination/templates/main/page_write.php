...
<div class="row">
  <div class="col-9 offset-1">
    ...
    <? if ($arResult['ACCESS'] || $arResult['ACCESS_TO_SECOND']): ?>
      ...
      <form action="" class="form_vaccination">
        ...
        <div class="input_group">
          ...
          <div class="ui-ctl ui-ctl-textbox">
            <input value="<?=$arResult['ACCESS_TO_SECOND'] ? $data['NAME'] ?? $USER->GetLastName().' '.$USER->GetFirstName().' '.$USER->GetSecondName() : ''?>" name="fio" id="fio" type="text" class="ui-ctl-element required">
          </div>
        </div>
