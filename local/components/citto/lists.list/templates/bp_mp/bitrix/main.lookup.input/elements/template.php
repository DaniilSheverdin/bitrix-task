...
<div class="mli-layout" id="layout_<?=$control_id?>">
    ...
    <textarea name="<?=$textarea_id?>" id="<?=$textarea_id?>"><?=(isset($arParams['INPUT_VALUE_STRING']))?htmlspecialcharsbx($arParams['INPUT_VALUE_STRING']):'';?></textarea>
    <?else :?>
    <input autocomplete="off" type="text" name="<?=$textarea_id?>" id="<?=$textarea_id?>" value="<?=(isset($arParams['INPUT_VALUE_STRING']))?htmlspecialcharsbx($arParams['INPUT_VALUE_STRING']):'';?>">
    <?endif?>
</div>
