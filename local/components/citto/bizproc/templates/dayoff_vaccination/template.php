...
<div class="ui-alert ui-alert-danger">
    <span class="ui-alert-message"><strong>Внимание!</strong><br>Работники обязаны в течение 5 рабочих дней со дня выхода на работу предоставить сведения, подтверждающие прохождение ими вакцинации или её этапа, полученные с использованием Единого портала государственных и муниципальных услуг (функций). </span>
</div>

<div class="ui-alert ui-alert-warning">
    <span class="ui-alert-message">Если руководитель организации/ОИВ и непосредственный руководитель – одно и то же лицо, то его/её достаточно указать в одном месте как руководителя организации/ОИВ</span>
</div>
