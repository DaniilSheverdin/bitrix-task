...
?>
<form enctype="multipart/form-data" class="needs-validation js-otpusk_czn" novalidate="" style="" id="js-otpusk_czn" action="<?=htmlspecialchars($_SERVER['REQUEST_URI'])?>" method="POST" autocomplete="Off">
    <input type="hidden" name="otpusk_czn" value="add">
    <?=bitrix_sessid_post()?>
