...
?>
<form enctype="multipart/form-data" class="needs-validation js-mentoring" id="js-mentoring" action="<?= htmlspecialchars($_SERVER['REQUEST_URI']) ?>"
      method="POST" autocomplete="Off">
    <input type="hidden" name="mentoring" value="add">
    <?= bitrix_sessid_post() ?>
