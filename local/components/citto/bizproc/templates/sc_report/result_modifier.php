...
$obLogger->pushHandler(
    new RotatingFileHandler(
        $_SERVER['DOCUMENT_ROOT'] . '/local/logs/sc_report/actions.log',
        60
    )
);
...
if ($arRequest['sc_report'] && $arRequest['sc_report'] == 'add') {
    try {
        Loader::includeModule("workflow");
