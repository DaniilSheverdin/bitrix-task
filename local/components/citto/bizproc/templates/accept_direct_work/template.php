...
?>
<form class="needs-validation js-accept_direct_work" novalidate="" style="" id="accept_direct_work" action="<?=htmlspecialchars($_SERVER['REQUEST_URI'])?>" method="POST" autocomplete="Off">
    <input type="hidden" name="sc_accept_direct_work" value="add">
    <?=bitrix_sessid_post()?>
