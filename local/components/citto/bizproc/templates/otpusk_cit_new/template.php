...
?>
<form enctype="multipart/form-data" class="needs-validation js-otpusk_cit_new" novalidate="" style="" id="js-otpusk_cit_new" action="<?=htmlspecialchars($_SERVER['REQUEST_URI'])?>" method="POST" autocomplete="Off">
    <input type="hidden" name="otpusk_cit_new" value="add">
    <?=bitrix_sessid_post()?>
