...
function changeCalendar(input) {
  ...
  setTimeout(function () {
    ...
    for (var i = 0; i < links.length; i++) {
      ...
      if (name === 'vac_date') {
        if (date - atrDate > 24 * 60 * 60 * 1000 || dateEnd - atrDate < 24 * 60 * 60 * 1000 || dateJuneStart - atrDate == 24 * 60 * 60 * 1000 || dateJuleStart - atrDate == 24 * 60 * 60 * 1000 || dateJuleStart2 - atrDate == 24 * 60 * 60 * 1000 || dateJuneEnd - atrDate == 24 * 60 * 60 * 1000 || dateJuleEnd - atrDate == 24 * 60 * 60 * 1000 || dateJuleEnd2 - atrDate == 24 * 60 * 60 * 1000) {
