    ...
    <div id="lnpa-detail-actions" class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <? else: ?>
                <h3 class="title">Добавление нового документа</h3>
                            ...
                            <div class="col-md-10">
                                ...
                                <? elseif ($arField['TYPE'] == 'enumeration'): ?>
                                    <? if ($arField['CODE'] == 'UF_STRUCTURE'): ?>
                                        <select multiple name="<?= $arField['CODE'] ?>[]" id="department" data-dropup-auto="false" data-size="5" data-live-search="true"
                                    ...
                                    <? else: ?>
                                        <select id="js-<?= $arField['CODE'] ?>" name="<?= $arField['CODE'] ?>" data-dropup-auto="false" data-size="5"
                                                data-live-search="true" data-live-search-placeholder="Найти" class="form-control selectpicker">
                                            <? foreach ($arField['LIST'] as $arEnum): ?>
                                                <option data-xml = "<?= $arEnum['XML_ID'] ?>" <? if ($arEnum['ID'] == $arField['VALUE']) echo 'selected' ?>
