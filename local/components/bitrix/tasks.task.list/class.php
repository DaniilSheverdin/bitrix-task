...
class TasksTaskListComponent extends TasksBaseComponent
{
	...
	protected function getSelect()
	{
		...
		} else if ($this->exportAs == 'EXCEL') {
            $columns[] = 'TIME_ESTIMATE';
            $columns[] = 'TIME_SPENT_IN_LOGS';
            $columns[] = 'START_DATE_PLAN';
            $columns[] = 'END_DATE_PLAN';
        }
	...
	protected function getData()
	{
        ...
        /* Чтоб при применении фильтра не выводились ВСЕГДА завершенные задачи */
        unset($getListParameters['legacyFilter']['::SUBFILTER-STATUS']['::SUBFILTER-2']);
