...
$MESS["BPAR_PD_TASK_CHECK_PARAMETER"] = "Ключевой параметр (код)";
$MESS["BPAR_PD_TASK_CHECK_PARAMETER_VALUE"] = "Значение, при котором скрыть";
$MESS["BPAR_PD_TASK_ARR_NON_PARAMETERS"] = "Скрываемые поля (коды через запятую)";
