...
<tr id="ria_pd_list_form">
	<td colspan="2">
		<table width="100%" class="adm-detail-content-table edit-table">
			...
			<tr>
				<td align="right" class="adm-detail-content-cell-l"><?= GetMessage("BPAR_PD_TASK_CHECK_PARAMETER") ?>:</td>
				<td class="adm-detail-content-cell-r"><?=CBPDocument::ShowParameterField("string", 'check_parameter', $arCurrentValues['check_parameter'], Array('size'=>'50'))?></td>
			</tr>
			<tr>
				<td align="right" class="adm-detail-content-cell-l"><?= GetMessage("BPAR_PD_TASK_CHECK_PARAMETER_VALUE") ?>:</td>
				<td class="adm-detail-content-cell-r"><?=CBPDocument::ShowParameterField("string", 'check_parameter_value', $arCurrentValues['check_parameter_value'], Array('size'=>'50'))?></td>
			</tr>
			<tr>
				<td align="right" class="adm-detail-content-cell-l"><?= GetMessage("BPAR_PD_TASK_ARR_NON_PARAMETERS") ?>:</td>
				<td class="adm-detail-content-cell-r"><?=CBPDocument::ShowParameterField("string", 'arr_non_parameters', $arCurrentValues['arr_non_parameters'], Array('rows'=>'7'))?></td>
			</tr>
			<tr>
