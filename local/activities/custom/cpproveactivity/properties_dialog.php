...
<tr>
    <td align="right" width="40%"><span class="adm-required-field">Файлы:</span></td>
    <td width="60%">
        <?=CBPDocument::ShowParameterField("string", 'approve_files', $arCurrentValues['approve_files'], array('size'=>'50'))?>
    </td>
</tr>
<tr>
    <td align="right" width="40%"><span class="">Позиция подписи:</span></td>
    <td width="60%">
        <?=CBPDocument::ShowParameterField("string", 'approve_position', $arCurrentValues['approve_position'], array('size'=>'50'))?>
    </td>
</tr>
<tr>
    <td align="right" width="40%"><span class="">Стереть из pdf(через запятую):</span></td>
    <td width="60%">
        <?=CBPDocument::ShowParameterField("string", 'approve_clearf', $arCurrentValues['approve_clearf'], array('size'=>'50'))?>
    </td>
</tr>
<tr>
    <td align="right">Дублировать подпись:</td>
    <td>
        <select name="double_sign">
            <?
            var_dump($arCurrentValues["double_sign"]);
            ?>
            <option value="N"<?= $arCurrentValues["double_sign"] != "Y" ? " selected" : "" ?>><?= GetMessage("BPAA_PD_NO") ?></option>
            <option value="Y"<?= $arCurrentValues["double_sign"] == "Y" ? " selected" : "" ?>><?= GetMessage("BPAA_PD_YES") ?></option>
        </select>
    </td>
</tr>
<tr>
