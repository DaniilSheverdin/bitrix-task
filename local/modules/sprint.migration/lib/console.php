...
class Console
{
    ...
    public function __construct($args) {
        ...
        if ($userlogin == 'admin') {
            ...
            $userlogin = mb_substr($userlogin, 6);
    ...
    public function commandList() {
        ...
        foreach ($versions as $index => $item) {
            ...
            $grid->addRow(array(
                $item['version'],
                GetMessage('SPRINT_MIGRATION_META_' . mb_strtoupper($item['status'])),
                $item['description'],
            ));
        ...
        foreach ($summary as $k => $v) {
            $grid->addRow(array(
                GetMessage('SPRINT_MIGRATION_META_' . mb_strtoupper($k)) . ':',
                $v
            ));
        }
