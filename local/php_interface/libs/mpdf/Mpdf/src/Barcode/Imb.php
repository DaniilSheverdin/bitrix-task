...
class Imb extends \Mpdf\Barcode\AbstractBarcode implements \Mpdf\Barcode\BarcodeInterface
{
	...
	private function init($code, $gapWidth, $daft)
	{
		...
		$binaryCode .= mb_substr($trackingNumber, 2, 18);
		...
		$binaryCodeArray = mb_substr($binaryCodeArray, 0, -1);
		...
		$binaryCode102bit = $first_byte . mb_substr($binaryCode, 2);
