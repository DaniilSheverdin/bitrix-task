...
(function(){
	...
	BX.Tasks.Component.TasksWidgetMemberSelector.ItemManager = BX.Tasks.UserItemSet.extend({
		...
		methods: {
			...
			{
				/**
				 * Чтобы запрос структуры пришёл в текущий шаблон
				 */
				this.instances.query.opts.url = '/local/templates/.default/components/bitrix/tasks.widget.member.selector/.default/ajax.php';
