;(function ()
{
	...
	BX.Timeman.Component.Worktime.Grid = function (options)
	{
		...
		{
			this.setCookie(this.useIndividualViolationRulesName, options.defaultViolationShowIndividual ? 'Y' : 'N', {path: sitePath, samesite: 'strict'});
		}
		this.scrollToToday();
		...
		buildGridConfigPopupItems: function ()
		{
			...
			if (this.gridConfigOptions.showStatsItem)
			{
				items.push({
					...
					onclick: function ()
					{
						this.setCookie(this.showStatsColumnsName, this.showStatsColumns() ? 'N' : 'Y', {path: sitePath, samesite: 'strict'});
			...
			if (this.gridConfigOptions.showStartEndItem)
			{
				items.push({
					...
					onclick: function ()
					{
						this.setCookie(this.showStartEndTimeName, this.showStartEndTime() ? 'N' : 'Y', {path: sitePath, samesite: 'strict'});
						this.closeGridConfigPopup();
						this.applyGridConfigOptions();
					}.bind(this)
				});
					...
					items: [
						{
							...
							onclick: function ()
							{
								this.setCookie(this.useIndividualViolationRulesName, 'Y', {path: sitePath, samesite: 'strict'});
								this.closeGridConfigPopup();
								this.applyGridConfigOptions();
							}.bind(this)
						},
						{
							...
							onclick: function ()
							{
								this.setCookie(this.useIndividualViolationRulesName, 'N', {path: sitePath, samesite: 'strict'});
								this.closeGridConfigPopup();
								this.applyGridConfigOptions();
							}.bind(this)
						}
					...
					items: [
						{
							...
							{
								this.closeGridConfigPopup();
								this.setCookie(this.useEmployeesTimezoneName, 'N', {path: sitePath, samesite: 'strict'});
								this.reloadGrid();
							}.bind(this)
						},
						{
							...
							{
								this.closeGridConfigPopup();
								this.setCookie(this.useEmployeesTimezoneName, 'Y', {path: sitePath, samesite: 'strict'});
								this.reloadGrid();
							}.bind(this)
						}
					]
