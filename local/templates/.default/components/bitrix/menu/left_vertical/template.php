...
<div class="menu-items-block" id="menu-items-block">
				...
				foreach ($arResult["ITEMS"][$status] as $item)
				{
					...
					><?
						...
						?><a
							...
							<?endif?>">
							<span class="menu-item-icon-box"><span class="menu-item-icon"><?=mb_strtoupper(mb_substr($item["TEXT"], 0, 1));?></span></span><?
	...
	<li id="bx_left_menu_menu_univer" data-status="show" data-id="menu_univer" data-counter-id="univer" data-link="https://university.tularegion.ru/" data-all-links="" data-type="default" data-delete-perm="N" data-new-page="N" class="menu-item-block menu-item-active">
		<span class="menu-fav-editable-btn menu-favorites-btn menu-fav-editable-btn-js" onclick="BX.Bitrix24.LeftMenuClass.openMenuPopup(this, 'menu_univer')">
				<span class="menu-favorites-btn-icon"></span>
		</span>

		<span class="menu-favorites-btn menu-favorites-draggable" onmousedown="BX.addClass(this.parentNode, 'menu-item-draggable');" onmouseup="BX.removeClass(this.parentNode, 'menu-item-draggable');">
			<span class="menu-fav-draggable-icon"></span>
		</span>

		<a
			class="menu-item-link"
			href="https://university.tularegion.ru/"
			title="Корпоративный университет"
			onclick="if (BX.Bitrix24.LeftMenuClass.isEditMode()) return false;<?if ($arParams['USERISINLOCAL'] == "Y"):?>BX.PopupWindowManager.create('left-menu-ku-message', null, { content: 'Для доступа к ресурсу необходимо сменить конфигурацию на «Открытый интернет».<br/><a href=\''+this.getAttribute('href')+'\' target=\'_blank\'>Перейти на сайт &rarr;</a>', darkMode: true, autoHide: true}).show(); event.preventDefault(); return false;<?endif;?>"
			>
			<span class="menu-item-icon-box menu-item-purple"><span class="menu-item-icon">У</span></span>
			<span class="menu-item-link-text menu-item-purple" data-role="item-text">
				Корпоративный университет
			</span>
			<span class="menu-item-index-wrap"><span class="menu-item-index" id="menu-counter-univer">0</span></span>
		</a>
	</li>
	<? endif; ?>
    <? if(CSite::InGroup([140, 141]) || getOmsuDep()) { ?>
        <li id="bx_left_menu_menu_vash_doctor" data-status="show" data-id="menu_kmoppn" data-counter-id="kmoppn" data-link="/services/kmoppn/" data-all-links="" data-type="default" data-delete-perm="N" data-new-page="N" class="menu-item-block menu-item-active">
			<span class="menu-fav-editable-btn menu-favorites-btn menu-fav-editable-btn-js" onclick="BX.Bitrix24.LeftMenuClass.openMenuPopup(this, 'menu_kmoppn')">
					<span class="menu-favorites-btn-icon"></span>
			</span>
            ...
            <a class="menu-item-link" href="/services/kmoppn/" title="Форма предварительной переписи населения" onclick="if (BX.Bitrix24.LeftMenuClass.isEditMode()) return false;
				">
                <span class="menu-item-icon-box menu-item-blueviolet"><span class="menu-item-icon">П</span></span>
                <span class="menu-item-link-text menu-item-blueviolet" data-role="item-text">
					Форма предварительной переписи населения
				</span>
                <span class="menu-item-index-wrap"><span class="menu-item-index" id="menu-counter-kmoppn">0</span></span>
            </a>
        </li>
    <? } ?>
	<?if (SITE_ID == 's1' && !CSite::InGroup([135])){?>
		<li id="bx_left_menu_menu_vash_doctor" data-status="show" data-id="menu_vash_doctor" data-counter-id="vash_doctor" data-link="/workgroups/group/635/" data-all-links="" data-type="default" data-delete-perm="N" data-new-page="N" class="menu-item-block menu-item-active">
			<span class="menu-fav-editable-btn menu-favorites-btn menu-fav-editable-btn-js" onclick="BX.Bitrix24.LeftMenuClass.openMenuPopup(this, 'menu_vash_doctor')">
					<span class="menu-favorites-btn-icon"></span>
			</span>
			...
			<a class="menu-item-link" href="/workgroups/group/635/" title="Ваш доктор" onclick="if (BX.Bitrix24.LeftMenuClass.isEditMode()) return false;
				">
				<span class="menu-item-icon-box menu-item-green"><span class="menu-item-icon">Д</span></span>
				<span class="menu-item-link-text menu-item-green" data-role="item-text">
					Ваш доктор
				</span>
				<span class="menu-item-index-wrap"><span class="menu-item-index" id="menu-counter-vash_doctor">0</span></span>
			</a>
		</li>
		<li id="bx_left_menu_menu_clean_doc" data-status="show" data-id="menu_clean_doc" data-counter-id="clean_doc" data-link="/workgroups/group/636/" data-all-links="" data-type="default" data-delete-perm="N" data-new-page="N" class="menu-item-block menu-item-active">
			<span class="menu-fav-editable-btn menu-favorites-btn menu-fav-editable-btn-js" onclick="BX.Bitrix24.LeftMenuClass.openMenuPopup(this, 'menu_clean_doc')">
					<span class="menu-favorites-btn-icon"></span>
			</span>
			...
			<a class="menu-item-link" href="/workgroups/group/667/" title="Повышаем грамотность" onclick="if (BX.Bitrix24.LeftMenuClass.isEditMode()) return false;
				">
				<span class="menu-item-icon-box menu-item-blue"><span class="menu-item-icon">П</span></span>
				<span class="menu-item-link-text menu-item-blue" data-role="item-text">
					Повышаем грамотность
				</span>
				<span class="menu-item-index-wrap"><span class="menu-item-index" id="menu-counter-clean_doc">0</span></span>
			</a>
		</li>
		<li id="bx_left_menu_menu_important_doc" data-status="show" data-id="menu_clean_doc" data-counter-id="clean_doc" data-link="/workgroups/group/886/" data-all-links="" data-type="default" data-delete-perm="N" data-new-page="N" class="menu-item-block menu-item-active">
			<span class="menu-fav-editable-btn menu-favorites-btn menu-fav-editable-btn-js" onclick="BX.Bitrix24.LeftMenuClass.openMenuPopup(this, 'menu_clean_doc')">
					<span class="menu-favorites-btn-icon"></span>
			</span>
			...
			<a class="menu-item-link" href="/workgroups/group/886/" title="Книжный клуб" onclick="if (BX.Bitrix24.LeftMenuClass.isEditMode()) return false;
				">
				<span class="menu-item-icon-box menu-item-red"><span class="menu-item-icon">В</span></span>
				<span class="menu-item-link-text menu-item-red" data-role="item-text">
					Книжный клуб
				</span>
				<span class="menu-item-index-wrap"><span class="menu-item-index" id="menu-counter-clean_doc">0</span></span>
			</a>
