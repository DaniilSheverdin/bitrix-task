...
$fields['data']['description']              = "(указывается дата доставки)";
$fields['kommentarii']['description']       = "срочно/ в течении часа и т.д.";
$fields['kommentarii']['type']              = "textarea";
$fields['email']['type']                    = "hidden";
$fields['email']['value']                   = $SOTRUDNIK['EMAIL'];
$fields['rabochiy_telefon']['type']         = "hidden";
$fields['rabochiy_telefon']['value']        = $SOTRUDNIK['WORK_PHONE'];
?>
