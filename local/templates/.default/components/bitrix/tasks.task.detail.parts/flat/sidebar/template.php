...
<div class="task-detail-sidebar">
	...
	<div class="task-detail-sidebar-content">
        ...
        <? if ($taskData['UF_UTILISATION_SU']) : ?>
            <div class="task-detail-sidebar-item">
                <div class="task-detail-sidebar-item-title">Утилизация:</div>
                <div class="task-detail-sidebar-item-value"><?=$taskData["UF_UTILISATION_SU"]?>&nbsp;ШЕ</div>
            </div>
        <? endif; ?>

        <? if ($taskData['UF_JUSTIFICATION']) : ?>
            <div class="task-detail-sidebar-item">
                <div class="task-detail-sidebar-item-title">Обоснование:</div>
                <div class="task-detail-sidebar-item-value"><?=$taskData["UF_JUSTIFICATION"]?></div>
            </div>
        <? endif; ?>
