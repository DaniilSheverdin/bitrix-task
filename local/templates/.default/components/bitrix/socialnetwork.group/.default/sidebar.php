...
?><div class="socialnetwork-group-sidebar-block">
    ...
    <table cellspacing="0" class="socialnetwork-group-layout">
        ...
        if (false && $arResult["GroupProperties"]["SHOW"] === "Y")
        {
        ...
        if ($arResult['CurrentUserPerms']['UserIsMember'] || $GLOBALS['USER']->IsAdmin()) {
            if (
                ...
                ?>
                <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column">Процент выполнения:</td>
                    <td class="socialnetwork-group-layout-right-column">
                        <?=number_format(array_sum($arPercent), 2, ',', '') . '%'?>
                    </td>
                </tr>
                <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column">Отклонение от плана:</td>
                    <td class="socialnetwork-group-layout-right-column" title="<?=$arDeviation['tooltip']?>">
                        <?=$arDeviation['sum']?>
                    </td>
                </tr>
                <?
        ...
        if ($arResult['Group']['UF_UTILISATION_SU']) {
            ?>
            <tr class="socialnetwork-group-layout-row">
                <td class="socialnetwork-group-layout-left-column">Утилизация:</td>
                <td class="socialnetwork-group-layout-right-column">
                    <?=$arResult['Group']['UF_UTILISATION_SU']?>&nbsp;ШЕ
                </td>
            </tr>
            <?
        }
        ...
        if ($arResult['Group']['UF_JUSTIFICATION']) {
            ?>
            <tr class="socialnetwork-group-layout-row">
                <td class="socialnetwork-group-layout-left-column">Обоснование:</td>
                <td class="socialnetwork-group-layout-right-column">
                    <?=$arResult['Group']['UF_JUSTIFICATION']?>
                </td>
            </tr>
            <?
        }
        ...
        if (array_key_exists('group_kpi', $arResult['ActiveFeatures'])) {
            ...
            if ((int)$kpiValue > 0) {
                ?>
                <tr class="socialnetwork-group-layout-row">
                    <td class="socialnetwork-group-layout-left-column"><?=$arResult['ActiveFeatures']['group_kpi']??'KPI'?>:</td>
                    <td class="socialnetwork-group-layout-right-column">
                        <?=$kpiValue?>%
                    </td>
                </tr>
