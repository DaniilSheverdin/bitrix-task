...
(function(){
    ...
    BX.Tasks.Component.Task = BX.Tasks.Util.Widget.extend({
        ...
        methods: {
            ...
            {
                this.instances.projectPlan = new BX.Tasks.Component.ProjectPlan({
            ...
            onToggleAdditionalBlock: function(node)
            {
                ...
                let utilisation = $('input[name="ACTION[0][ARGUMENTS][data][UF_UTILISATION_SU]"]');
    ...
    BX.Tasks.Component.ProjectPlan = BX.Tasks.Shared.Form.ProjectPlan.extend({
        methods: {
            solveTriangle: function(startChange, endChange, durationChange)
            {
                ...
                if (durationChange)
                {
                    if (duration >= 0) // changed to non-zero
                    {
                        if (startDate)
                        {
