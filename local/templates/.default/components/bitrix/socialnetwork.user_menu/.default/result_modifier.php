...
$arResult['CanView']['my_bizproc'] = true;

if ($GLOBALS['USER_IS_PODVED']) {
	$arResult['CanView']['files'] = false;
	$arResult['CanView']['tasks'] = false;
	$arResult['CanView']['calendar'] = false;
	$arResult['CanView']['my_bizproc'] = false;
}
