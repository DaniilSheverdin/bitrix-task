...
<?$APPLICATION->IncludeComponent("bitrix:socialnetwork_user", ".default", Array(
	...
	"PATH_TO_GROUP_SUBSCRIBE" => "/edu/workgroups/group/#group_id#/subscribe/",
	"PATH_TO_GROUP_SEARCH" => "/edu/workgroups/group/search/",
	"PATH_TO_SEARCH_EXTERNAL" => "/edu/company/index.php",
	...
	"PATH_TO_GROUP_POST" => "/edu/workgroups/group/#group_id#/blog/#post_id#/",
	"PATH_TO_GROUP_PHOTO" => "/edu/workgroups/group/#group_id#/photo/",
	"PATH_TO_GROUP_PHOTO_SECTION" => "/edu/workgroups/group/#group_id#/photo/album/#section_id#/",
	"PATH_TO_GROUP_PHOTO_ELEMENT" => "/edu/workgroups/group/#group_id#/photo/#section_id#/#element_id#/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/edu/company/personal/",
	"AJAX_MODE" => "N",
	...
	"CALENDAR_RES_MEETING_IBLOCK_ID" => "180",
	"CALENDAR_PATH_TO_RES_MEETING" => "/edu/services/?page=meeting&meeting_id=#id#",
	...
	"CALENDAR_PATH_TO_VIDEO_MEETING_DETAIL" => "/edu/services/video/detail.php?ID=#ID#",
	"CALENDAR_PATH_TO_VIDEO_MEETING" => "/edu/services/video/",
