...
if(CModule::IncludeModule('voximplant'))
{
	$aMenuLinks = Array(
		Array(
			...
			"/edu/services/telephony/lines.php",
		...
		Array(
			...
			"/edu/services/telephony/index.php",
		...
		Array(
			...
			"/edu/services/telephony/users.php",
			Array(),
		...
		Array(
			...
			"/edu/services/telephony/groups.php",
		...
		Array(
			...
			"/edu/services/telephony/phones.php",
			Array(),
		...
		Array(
			...
			"/edu/services/telephony/permissions.php",
		...
		Array(
			...
			"/edu/services/telephony/ivr.php",
		...
		Array(
			...
			"/edu/services/telephony/configs.php",
			Array(),
