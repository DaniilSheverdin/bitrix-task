...
<?=GetMessage("SERVICES_INFO1", array("#SITE#" => "/edu/"))?>
<?
if (CModule::IncludeModule("intranet") && CModule::IncludeModule("iblock"))
{
?>
<table style="margin-top:7px;">
	<tr><td><li><a href="javascript:<?echo htmlspecialcharsbx(CIntranetUtils::GetStsSyncURL(array('LINK_URL' => '/edu/company/'), 'contacts'))?>"><?=GetMessage("SERVICES_LINK1")?></a></td></tr>
...
<?=GetMessage("SERVICES_INFO2", array("#SITE#" => "/edu/"))?>
=======
<?
require($_SERVER["DOCUMENT_ROOT"]."/bitrix/header.php");
IncludeModuleLangFile($_SERVER["DOCUMENT_ROOT"]."/bitrix/modules/intranet/public/services/help/outlook.php");
