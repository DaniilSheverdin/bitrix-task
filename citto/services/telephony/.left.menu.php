...
if(CModule::IncludeModule('voximplant'))
{
	$aMenuLinks = Array(
		Array(
			...
			"/citto/services/telephony/lines.php",
		...
		Array(
			...
			"/citto/services/telephony/index.php",
		...
		Array(
			...
			"/citto/services/telephony/users.php",
			Array(),
		...
		Array(
			...
			"/citto/services/telephony/groups.php",
		...
		Array(
			...
			"/citto/services/telephony/phones.php",
			Array(),
		...
		Array(
			...
			"/citto/services/telephony/permissions.php",
		...
		Array(
			...
			"/citto/services/telephony/ivr.php",
		...
		Array(
			...
			"/citto/services/telephony/configs.php",
			Array(),
