...
<?$APPLICATION->IncludeComponent("bitrix:intranet.structure.birthday.nearest", ".default", Array(
	...
	"PM_URL"	=>	"/agro/company/personal/messages/chat/#USER_ID#/",
	"PATH_TO_CONPANY_DEPARTMENT" => "/agro/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_VIDEO_CALL" => "/agro/company/personal/video/#USER_ID#/",
