...
if(CModule::IncludeModule('voximplant'))
{
	$aMenuLinks = Array(
		Array(
			...
			"/gusc/services/telephony/lines.php",
		...
		Array(
			...
			"/gusc/services/telephony/index.php",
		...
		Array(
			...
			"/gusc/services/telephony/users.php",
			Array(),
		...
		Array(
			...
			"/gusc/services/telephony/groups.php",
		...
		Array(
			...
			"/gusc/services/telephony/phones.php",
			Array(),
		...
		Array(
			...
			"/gusc/services/telephony/permissions.php",
		...
		Array(
			...
			"/gusc/services/telephony/ivr.php",
		...
		Array(
			...
			"/gusc/services/telephony/configs.php",
			Array(),
