...
if (!isset($_REQUEST['structure_UF_DEPARTMENT'])) {
    LocalRedirect('/gusc/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=3080');
}
?>
<?$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "PM_URL"    => "/gusc/company/personal/messages/chat/#USER_ID#/",
        "USERS_PER_PAGE"    =>  "25",
