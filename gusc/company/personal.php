...
<?$APPLICATION->IncludeComponent("bitrix:socialnetwork_user", ".default", Array(
	...
	"PATH_TO_GROUP_SUBSCRIBE" => "/gusc/workgroups/group/#group_id#/subscribe/",
	"PATH_TO_GROUP_SEARCH" => "/gusc/workgroups/group/search/",
	...
	"PATH_TO_GROUP_POST" => "/gusc/workgroups/group/#group_id#/blog/#post_id#/",
	"PATH_TO_GROUP_PHOTO" => "/gusc/workgroups/group/#group_id#/photo/",
	"PATH_TO_GROUP_PHOTO_SECTION" => "/gusc/workgroups/group/#group_id#/photo/album/#section_id#/",
	"PATH_TO_GROUP_PHOTO_ELEMENT" => "/gusc/workgroups/group/#group_id#/photo/#section_id#/#element_id#/",
	"SEF_MODE" => "Y",
	"SEF_FOLDER" => "/gusc/company/personal/",
	"AJAX_MODE" => "N",
