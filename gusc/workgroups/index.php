...
?><?$APPLICATION->IncludeComponent("bitrix:socialnetwork_group", ".default", Array(
	...
	"PATH_TO_SUBSCRIBE" => "/gusc/company/personal/subscribe/",
	"PATH_TO_GROUP_CREATE"	=>	"/gusc/company/personal/user/#user_id#/groups/create/",
	"PATH_TO_SEARCH_EXTERNAL"	=>	"/gusc/company/index.php",
	"PATH_TO_CONPANY_DEPARTMENT" => "/gusc/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_MESSAGES_CHAT" => "/gusc/company/personal/messages/chat/#user_id#/",
	"PATH_TO_USER_CALENDAR" => "/gusc/company/personal/user/#user_id#/calendar/",
	"PATH_TO_MESSAGE_FORM_MESS" => "/gusc/company/personal/messages/form/#user_id#/#message_id#/",
	"PATH_TO_USER_LOG" => "/gusc/company/personal/log/",
	"PATH_TO_VIDEO_CALL" => "/gusc/company/personal/video/#user_id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/gusc/company/personal/user/#user_id#/bizproc/",
	"PATH_TO_BIZPROC_TASK" => "/gusc/company/personal/user/#user_id#/bizproc/#id#/",
	"SEF_MODE"	=>	"Y",
	"SEF_FOLDER"	=>	"/gusc/workgroups/",
	"AJAX_MODE"	=>	"N",
	...
	"CALENDAR_RES_MEETING_IBLOCK_ID" => "583",
	"CALENDAR_PATH_TO_RES_MEETING" => "/gusc/services/?page=meeting&meeting_id=#id#",
	...
	"CALENDAR_PATH_TO_VIDEO_MEETING_DETAIL" => "/gusc/services/video/detail.php?ID=#ID#",
	"CALENDAR_PATH_TO_VIDEO_MEETING" => "/gusc/services/video/",
