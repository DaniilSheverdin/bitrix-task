...
$APPLICATION->AddHeadScript("/stream/index.js");
CJSCore::Init(array("jquery"));

/*if (CSite::InGroup([96])) {
    // Пользователей из отделов Контроль поручений редиректнуть в модуль КП
    CModule::IncludeModule('intranet');
    $arControlDeps = CIntranetUtils::GetDeparmentsTree(2137, true);
    $arControlDeps[] = 2137;
