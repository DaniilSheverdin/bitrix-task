...
if(CModule::IncludeModule('calendar')):
	$APPLICATION->IncludeComponent("bitrix:calendar.events.list", "widget", array(
		...
		"DETAIL_URL" => "/mfc/company/personal/user/#user_id#/calendar/",
		"EVENTS_COUNT" => "5",
		"CACHE_TYPE" => "N",
		"CACHE_TIME" => "3600"
		),
...
if(CModule::IncludeModule('tasks')):
	$APPLICATION->IncludeComponent(
		...
		array(
			...
			"USER_ID" => $USER->GetID(),
			"ROLE_FILTER_SUFFIX" => "",
			"PATH_TO_TASKS" => "/mfc/company/personal/user/".$USER->GetID()."/tasks/",
			"CHECK_TASK_IN" => "R"
		),
		null,
		array("HIDE_ICONS" => "N")
...
<?if ($GLOBALS["USER"]->IsAuthorized())
{
	$APPLICATION->IncludeComponent("bitrix:socialnetwork.blog.blog", "important",
		Array(
			...
			"USER_VAR" => "",
			"PAGE_VAR" => "",
			"PATH_TO_BLOG" => "/mfc/company/personal/user/#user_id#/blog/",
			"PATH_TO_BLOG_CATEGORY" => "",
			"PATH_TO_BLOG_POSTS" => "/mfc/company/personal/user/#user_id#/blog/important/",
			"PATH_TO_POST" => "/mfc/company/personal/user/#user_id#/blog/#post_id#/",
			"PATH_TO_POST_EDIT" => "/mfc/company/personal/user/#user_id#/blog/edit/#post_id#/",
			"PATH_TO_USER" => "/mfc/company/personal/user/#user_id#/",
...
<?$APPLICATION->IncludeComponent("bitrix:blog.popular_posts", "widget", array(
	...
	"DATE_TIME_FORMAT" => (LANGUAGE_ID == "en") ? "F j, Y h:i a" : ((LANGUAGE_ID == "de") ? "j. F Y H:i:s" : "d.m.Y H:i:s"),
	"PATH_TO_BLOG" => "/mfc/company/personal/user/#user_id#/blog/",
	"PATH_TO_GROUP_BLOG_POST" => "/mfc/workgroups/group/#group_id#/blog/#post_id#/",
	"PATH_TO_POST" => "/mfc/company/personal/user/#user_id#/blog/#post_id#/",
	"PATH_TO_USER" => "/mfc/company/personal/user/#user_id#/",
	"CACHE_TYPE" => "A",
	"CACHE_TIME" => "3600",
...
<?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"SHOW_YEAR" => "N",
		"DETAIL_URL" => "/mfc/company/personal/user/#USER_ID#/",
		"DEPARTMENT" => 58,
...
<?if(CModule::IncludeModule('bizproc')):
	$APPLICATION->IncludeComponent(
		...
		array(
			'COUNTERS_ONLY' => 'Y',
			'USER_ID' => $USER->GetID(),
			'PATH_TO_BP_TASKS' => '/mfc/company/personal/bizproc/',
			'PATH_TO_MY_PROCESSES' => '/mfc/company/personal/processes/',
		),
		null,
		array('HIDE_ICONS' => 'N')
	);
