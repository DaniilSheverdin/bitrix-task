...
<tr><td><li><a href="javascript:<?echo htmlspecialcharsbx(CIntranetUtils::GetStsSyncURL(array('LINK_URL' => '/mfc/company/'), 'contacts'))?>"><?=GetMessage("COMPANY_CONTACTS")?></a></td></tr>
