...
?><?$APPLICATION->IncludeComponent("bitrix:socialnetwork_group", ".default", Array(
	...
	"PATH_TO_SUBSCRIBE" => "/mfc/company/personal/subscribe/",
	"PATH_TO_GROUP_CREATE"	=>	"/mfc/company/personal/user/#user_id#/groups/create/",
	"PATH_TO_SEARCH_EXTERNAL"	=>	"/mfc/company/index.php",
	"PATH_TO_CONPANY_DEPARTMENT" => "/mfc/company/structure.php?set_filter_structure=Y&structure_UF_DEPARTMENT=#ID#",
	"PATH_TO_MESSAGES_CHAT" => "/mfc/company/personal/messages/chat/#user_id#/",
	"PATH_TO_USER_CALENDAR" => "/mfc/company/personal/user/#user_id#/calendar/",
	"PATH_TO_MESSAGE_FORM_MESS" => "/mfc/company/personal/messages/form/#user_id#/#message_id#/",
	"PATH_TO_USER_LOG" => "/mfc/company/personal/log/",
	"PATH_TO_VIDEO_CALL" => "/mfc/company/personal/video/#user_id#/",
	"PATH_TO_BIZPROC_TASK_LIST" => "/mfc/company/personal/user/#user_id#/bizproc/",
	"PATH_TO_BIZPROC_TASK" => "/mfc/company/personal/user/#user_id#/bizproc/#id#/",
	"SEF_MODE"	=>	"Y",
	"SEF_FOLDER"	=>	"/mfc/workgroups/",
	"AJAX_MODE"	=>	"N",
	...
	"CALENDAR_PATH_TO_RES_MEETING" => "/mfc/services/?page=meeting&meeting_id=#id#",
	...
	"CALENDAR_PATH_TO_VIDEO_MEETING_DETAIL" => "/mfc/services/video/detail.php?ID=#ID#",
	"CALENDAR_PATH_TO_VIDEO_MEETING" => "/mfc/services/video/",
